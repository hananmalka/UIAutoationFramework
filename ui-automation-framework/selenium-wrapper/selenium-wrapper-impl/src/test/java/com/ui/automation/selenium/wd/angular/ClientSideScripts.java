...
//        }
    ...
    private boolean isMaasAppLoaded() {
        ...
        return !getDriverServices().getDriver().getCurrentUrl().toLowerCase().contains("authentication");
...
//        return (Boolean) getDriverServices().executeJavaScript("return window.angular !== undefined");
        return (Boolean) getDriverServices().executeJavaScript("return window.readyState !== 'complete'");
    }
