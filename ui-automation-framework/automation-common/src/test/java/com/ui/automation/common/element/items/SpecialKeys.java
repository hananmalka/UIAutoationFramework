package com.ui.automation.common.element.items;

/**
 * Copy of org.openqa.selenium.Keys so that we don't need to expose the entire Selenium jar outside
 *
 *
...
public enum SpecialKeys implements CharSequence {
    ...
    public static String chord(CharSequence... value) {
        ...
        builder.append(SpecialKeys.NULL);
        return builder.toString();
    }

    /**
     * Get the special key representation, {@link SpecialKeys}, of the supplied character if there is one. If
     ...
     */
    public static SpecialKeys getKeyFromUnicode(char key) {
        for (SpecialKeys unicodeKey : values()) {
