...
public class Table extends BaseElement {
    ...
    //TODO: Add class to row in dev code
    //TODO: Add class to all cells in all tables
    protected final String GRID_ROW_CLASS = "slick-row";
    protected final String GRID_CELL_CLASS = "-cell";

    public Table(Element parent) {
        super(Locator.className("react-bs-table"), parent);
    }

    public Table(Locator self, Element parent) {
        super(self, parent);
    }
    ...
    protected Element viewport() {
        return new BaseElement(Locator.css("tr"), this);
    }
